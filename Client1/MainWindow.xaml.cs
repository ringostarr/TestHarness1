    ...
    public partial class MainWindow : Window
    {
        ...
        private void button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                Message msg = cs.makeMessage("Client1", cs.endpoint, cs.endpoint);
        ...
        private void Createxmlbutton_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (StringValue x in dataGrid.SelectedItems)
            {
            ...
            foreach (StringValue x in dataGrid1.SelectedItems)
            {
            ...
            string xml = XmlCreator.MessageTest.makeTestRequest(fns[0], fns2, "CLient1");
            xmlviewer.Text = xml;
        }
        ...
        private void Logresults_Click(object sender, RoutedEventArgs e)
        {
            ...
            string filename = "Client1" + DateTime.Now.Month + DateTime.Now.Day + DateTime.Now.Year + ".log";
            try
            {
